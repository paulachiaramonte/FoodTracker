...
public final class FragmentSettingsBinding implements ViewBinding {
  ...
  private FragmentSettingsBinding(@NonNull ConstraintLayout rootView,
      @NonNull FloatingActionButton imageView5, @NonNull TextView textSettings,
  ...
  public static FragmentSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.imageView5;
      FloatingActionButton imageView5 = ViewBindings.findChildViewById(rootView, id);
      if (imageView5 == null) {
        break missingId;
      }
      ...
      return new FragmentSettingsBinding((ConstraintLayout) rootView, imageView5, textSettings,
          textView);
    }
